...
namespace OkiJobAPI.Data
{
	public static class DbInitializer
	{
		public static void Initialize(SharedContext context)
		{
			...
			Material Valkite = new() { Name = "Valkite", Price = 10 };
			context.Materials.Add(Valkite);
			Material Ajatite = new() { Name = "Ajatite", Price = 20 };
			context.Materials.Add(Ajatite);
			Material Bastium = new() { Name = "Bastium", Price = 200 };
			context.Materials.Add(Bastium);
			context.SaveChanges();

			Ship TestShip = new() { Name = "TestShip", Designer = "Okim", Description = "A fake ship that doesn't exist" };
